...
# This command recursively copies all files, including hidden ones, from the 'Zapp' directory to the '/var/www/html/'
sudo cp -R Zapp/. /var/www/html/

# This command permanently deletes the 'app' directory and the 'app.zip' file.
sudo rm -rf Zapp Zapp.zip
